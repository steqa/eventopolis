    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=260, unique=True, verbose_name='электронная почта')),
                ('first_name', models.CharField(max_length=150, verbose_name='имя')),
                ('last_name', models.CharField(max_length=150, verbose_name='фамилия')),
                ('about_me', models.TextField(blank=True, max_length=150, null=True, verbose_name='обо мне')),
                ...
                ('telegram_notifications', models.BooleanField(default=False, verbose_name='получать уведомления в телеграм')),
                ('image', models.ImageField(default=authentication.models._get_default_image, upload_to=authentication.models._get_image_filepath, verbose_name='изображение')),
